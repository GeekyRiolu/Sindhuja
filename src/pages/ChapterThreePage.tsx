        ...
        <div className="flex justify-between items-center mt-16 fade-in-up">
          ...
          <Link to="/epilogue">
            <Button 
              onClick={handleNavigation}
              size="lg" 
              className="bg-romantic-cream hover:bg-romantic-cream/90 text-white font-semibold px-8 py-3 rounded-full shadow-floating transition-all duration-500 hover:scale-105"
            >
              The End
